...
export class HomePage {
 ...
 whatsappShare(){
    this.sharingVar.shareViaWhatsApp("Message via WhatsApp", null /*Image*/,  "https://pointdeveloper.com/" /* url */)
      .then(()=>{
        alert("Success");
      },
      ()=>{
  ...
  otherShare(){
    this.sharingVar.share("Genral Share Sheet",null/*Subject*/,null/*File*/,"https://pointdeveloper.com")
    .then(()=>{
        alert("Success");
      },
      ()=>{
